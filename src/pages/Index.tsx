...
const TemplateCard = ({
  ...
  <div className="cv-section cursor-pointer hover:shadow-lg p-6 rounded-lg border border-gray-300 transition duration-300" onClick={onClick}>
    <div className="text-4xl mb-4"><FileSearch /></div>
    <h3 className="text-xl font-semibold mb-2">{title}</h3>
    <p className="text-gray-600">{description}</p>
  </div>
);
